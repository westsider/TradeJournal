...
class EditTradeWidget extends StatefulWidget {
  const EditTradeWidget({
    Key key,
    this.tradeID,
  }) : super(key: key);

  final DocumentReference tradeID;

  @override
  _EditTradeWidgetState createState() => _EditTradeWidgetState();
}

class _EditTradeWidgetState extends State<EditTradeWidget> {
  DateTime datePicked;
  ...
  Widget build(BuildContext context) {
    return StreamBuilder<TradeRecord>(
      stream: TradeRecord.getDocument(widget.tradeID),
      builder: (context, snapshot) {
        ...
        final editTradeTradeRecord = snapshot.data;
        return Scaffold(
          key: scaffoldKey,
          appBar: AppBar(
                        ...
                        Align(
                          ...
                          child: Row(
                            ...
                            children: [
                              Padding(
                                padding:
                                    EdgeInsetsDirectional.fromSTEB(8, 2, 8, 2),
                                child: FFButtonWidget(
                                  ...
                                  text: dateTimeFormat(
                                      'yMMMd', editTradeTradeRecord.createdAt),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown(
                                initialOption: dropDownContractValue ??=
                                    editTradeTradeRecord.contract,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown(
                                initialOption: dropDownDirectionValue ??=
                                    editTradeTradeRecord.tradeDirection,
                                options: ['Long', 'Short'].toList(),
                                onChanged: (val) => setState(
                                    () => dropDownDirectionValue = val),
                                width: 180,
                                height: 50,
                                textStyle:
                                    FlutterFlowTheme.of(context).bodyText1,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown(
                                initialOption: dropDownTradeTypeValue ??=
                                    editTradeTradeRecord.tradeType,
                                options: ['Join', 'Fade'].toList(),
                                onChanged: (val) => setState(
                                    () => dropDownTradeTypeValue = val),
                                width: 180,
                                height: 50,
                                textStyle:
                                    FlutterFlowTheme.of(context).bodyText1,
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon:
                                        textFieldT1Controller.text.isNotEmpty
                                            ? InkWell(
                                                onTap: () => setState(
                                                  () => textFieldT1Controller
                                                      ?.clear(),
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon:
                                        textFieldT2Controller.text.isNotEmpty
                                            ? InkWell(
                                                onTap: () => setState(
                                                  () => textFieldT2Controller
                                                      ?.clear(),
                              ...
                              Expanded(
                                child: TextFormField(
                                  ...
                                  decoration: InputDecoration(
                                    ...
                                    suffixIcon:
                                        textFieldT3Controller.text.isNotEmpty
                                            ? InkWell(
                                                onTap: () => setState(
                                                  () => textFieldT3Controller
                                                      ?.clear(),
                                ...
                                child: Padding(
                                  ...
                                  child: TextFormField(
                                    controller: textController6 ??=
                                        TextEditingController(
                                      text: editTradeTradeRecord.error,
                                    ),
                                    onChanged: (_) => EasyDebounce.debounce(
                                      'textController6',
                                      Duration(milliseconds: 2000),
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown(
                                initialOption: dropDownRateEntryValue ??=
                                    editTradeTradeRecord.reviewEntry,
                                options: ['0', '5', '10'].toList(),
                                onChanged: (val) => setState(
                                    () => dropDownRateEntryValue = val),
                                width: 180,
                                height: 50,
                                textStyle:
                                    FlutterFlowTheme.of(context).bodyText1,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown(
                                initialOption: dropDownRateRiskValue ??=
                                    editTradeTradeRecord.reviewRisk,
                                options: ['0', '5', '10'].toList(),
                                onChanged: (val) =>
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown(
                                initialOption: dropDownRateScaleValue ??=
                                    editTradeTradeRecord.reviewScale,
                                options: ['0', '5', '10'].toList(),
                                onChanged: (val) => setState(
                                    () => dropDownRateScaleValue = val),
                                width: 180,
                                height: 50,
                                textStyle:
                                    FlutterFlowTheme.of(context).bodyText1,
                        ...
                        Padding(
                          ...
                          child: Row(
                            ...
                            children: [
                              ...
                              FlutterFlowDropDown(
                                initialOption: dropDownRateExitValue ??=
                                    editTradeTradeRecord.reviewExit,
                                options: ['0', '5', '10'].toList(),
                                onChanged: (val) =>
